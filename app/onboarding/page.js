      ...
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .bg-glow1 {
          ...
          top: -150px; left: 50%; transform: translateX(-50%); pointer-events: none; z-index: 0;
        }
        .bg-glow2 {
        ...
        .card {
          ...
          border-radius: 28px; padding: 3rem 2.5rem; width: 100%; max-width: 560px;
          position: relative; z-index: 1;
          box-shadow: 0 0 80px rgba(124,58,237,0.08), inset 0 1px 0 rgba(255,255,255,0.06);
        }

        .logo {
          font-family: 'Bebas Neue', cursive; font-size: 1.6rem; letter-spacing: 0.06em;
        ...
        .prog-circle {
          ...
          border: 1.5px solid rgba(255,255,255,0.1); color: #6b7280;
        ...
        .prog-line {
          width: 60px; height: 1px; background: rgba(255,255,255,0.08);
        ...
        .step-tag {
          ...
          text-transform: uppercase; color: #7c3aed; margin-bottom: 0.75rem;
        }
        .step-title {
          font-family: 'Bebas Neue', cursive; font-size: 2.2rem;
          letter-spacing: 0.03em; color: #fff; margin-bottom: 0.5rem;
          line-height: 1; text-shadow: 0 0 40px rgba(124,58,237,0.3);
        }
        .step-desc {
          font-size: 0.88rem; color: #9ca3af; margin-bottom: 1.5rem; line-height: 1.6;
        }

        .textarea {
          width: 100%; background: rgba(255,255,255,0.04);
          border: 1px solid rgba(255,255,255,0.1); color: #fff;
          padding: 1rem 1.25rem; border-radius: 14px; font-size: 0.95rem;
          font-family: 'Inter', sans-serif; outline: none; resize: none;
          transition: all 0.2s; line-height: 1.6; min-height: 120px;
        }
        .textarea:focus {
        ...
        .example {
          font-size: 0.78rem; color: #4b5563; margin-top: 0.6rem; font-style: italic;
        }
        ...
        .btn-back {
          ...
          color: #9ca3af; padding: 0.85rem 1.5rem; border-radius: 12px;
        ...
        .char-count {
          font-size: 0.72rem; color: #4b5563; text-align: right; margin-top: 0.4rem;
        }
      `}</style>
        ...
        <div className="progress-track">
          {steps.map((s, i) => (
            <div key={s.num} style={{ display: "flex", alignItems: "center" }}>
              ...
              {i < steps.length - 1 && (
                <div className={`prog-line ${step > s.num ? "done" : ""}`} />
              )}
            </div>
          ))}
        </div>
        ...
        {step === 3 && (
          <div className="step-content">
            ...
            <div className="btn-row">
              ...
              >
                {loading ? "Launching your AI company..." : "Submit & Launch →"}
              </button>
            </div>
          </div>
        )}
